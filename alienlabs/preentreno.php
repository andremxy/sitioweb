...
<!-- Contenido específico de la página de Pre-entrenos -->
<div class="container">
  <div class="row">
    <?php
    ...
    $sql = "SELECT * FROM products WHERE name LIKE '%Pre Workout%' OR name LIKE '%Pre-entreno%'";
    ...
    ?>
      <p>No hay productos de preentrenos disponibles en este momento.</p>
    <?php endif; ?>
  </div>
</div>
